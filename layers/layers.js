...
lyr_StudyArea_PointVillages3Projected_1.set('fieldLabels', {'Join_Count': 'no label', 'TARGET_FID': 'no label', 'JOIN_FID': 'no label', 'X': 'no label', 'Y': 'no label', 'Type_of_Co': 'inline label - always visible', 'Joint_Code': 'no label', 'Date': 'no label', 'Year': 'no label', 'M_Kiti_Kij': 'no label', 'TAREHE': 'no label', 'OBJECTID': 'no label', 'Region_Cod': 'no label', 'Region_Nam': 'no label', 'District_C': 'no label', 'District_N': 'no label', 'Ward_Code': 'no label', 'Ward_Name': 'no label', 'Vil_Mtaa_N': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', 'Village_Co': 'no label', 'Pop_densit': 'no label', 'Rinfall': 'no label', 'Rainfall': 'no label', 'Temperatur': 'no label', 'Popl_Denst': 'no label', 'Recla24AG': 'no label', 'RoadS': 'no label', 'SerengetiB': 'no label', 'Settlement': 'no label', 'Riverwater': 'no label', 'LULC': 'no label', 'ReclLULC': 'no label', });
